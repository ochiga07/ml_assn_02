...
ცუდი სახელი დავარქვი აშკარად, მაგრამ ეს კლასი ქმნის ახალ feature-ებს არსებული სვეტებიდან, რომლებიც აღწერენ თითოეული ბარათის ქცევის პატერნს — რადგან ერთი ტრანზაქცია 
...
| Penalty | C | CV AUC mean | CV Train AUC | CV AUC std |
|---|---|---|---|---|
| L2 | 0.01 | 0.8397 | 0.8423 | 0.0007 |
| L2 | 0.1 | 0.8398 | 0.8425 | 0.0008 |
| **L2** | **1** | **0.8398** | **0.8425** | **0.0008** |
| L1 | 0.01 | 0.8390 | 0.8413 | 0.0006 |
| L1 | 0.1 | 0.8398 | 0.8424 | 0.0008 |
| L1 | 1 | 0.8398 | 0.8425 | 0.0008 |
